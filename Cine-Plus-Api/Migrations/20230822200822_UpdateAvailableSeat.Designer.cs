...
namespace Cine_Plus_Api.Migrations
{
    ...
    [Migration("20230822200822_UpdateAvailableSeat")]
    partial class UpdateAvailableSeat
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cine_Plus_Api.Models.PaidSeat", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Cine_Plus_Api.Models.PayOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Cine_Plus_Api.Models.Discount", b =>
                {
                    b.HasOne("Cine_Plus_Api.Models.PaidSeat", null)
                        .WithMany("Discounts")
                        .HasForeignKey("PaidSeatId");
                });
            ...
            modelBuilder.Entity("Cine_Plus_Api.Models.PaidSeat", b =>
                {
                    b.HasOne("Cine_Plus_Api.Models.PayOrder", "PayOrder")
                        .WithMany("PaidSeats")
                        .HasForeignKey("PayOrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
