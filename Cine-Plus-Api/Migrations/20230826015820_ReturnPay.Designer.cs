...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cine_Plus_Api.Models.ReturnPay", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasDiscriminator<string>("Discriminator").HasValue("ReturnPay");
            ...
            modelBuilder.Entity("Cine_Plus_Api.Models.ReturnCreditCard", b =>
                {
                    b.HasBaseType("Cine_Plus_Api.Models.ReturnPay");

                    b.Property<double>("Amount")
                        .HasColumnType("double");

                    b.HasDiscriminator().HasValue("ReturnCreditCard");
                });

            modelBuilder.Entity("Cine_Plus_Api.Models.ReturnPointsUser", b =>
                {
                    b.HasBaseType("Cine_Plus_Api.Models.ReturnPay");
                    ...
                    b.HasDiscriminator().HasValue("ReturnPointsUser");
                });
            ...
            modelBuilder.Entity("Cine_Plus_Api.Models.ReturnPay", b =>
                {
                    ...
                    b.HasOne("Cine_Plus_Api.Models.Seat", "Seat")
                        .WithMany("ReturnPays")
            ...
            modelBuilder.Entity("Cine_Plus_Api.Models.Employ", b =>
                {
                    b.Navigation("TicketPointsUsers");
